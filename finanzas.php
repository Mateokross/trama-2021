  ...
  <main class="club finanzas">
        ...
        <div class="container">
          <div class="row valign-row-l" data-aos="fade-up">
            <div class="col s12 m12 l5">
              <h1>Club Finanzas</h1>
              <h5>¿Te gustaría iniciarte en el mundo de las finanzas? ¿Querés aprender pero no sabes por dónde empezar? En el Club de Finanzas de Trama ITBA organizamos actividades para ayudarte a introducirte en este apasionante mundo! Competencias de trading, crypto, challenges, charlas y mucho más!</h5>
            </div>
      ...
      <div class="row valign-row-l" data-aos="fade-up">
        <div class="col s12 m6 l4 member-card-container">
          <div class="member-card">
            ...
            <p class="name">Benjamín Durruty</p>
    ...
    <section class="alt-container section main-activity" >
      ...
      <div class="row valign-row-l" data-aos="fade-up">
        ...
        <div class="col s12 m12 l6">
          <p>Durante esta competencia equipos de hasta tres jugadores realizan inversiones con plata ficticia a lo largo de un mes en un simulador de la bolsa de Nueva York. Los equipos con mayores retornos clasifican a una final donde deben defender su estrategia de inversión ante jurados especializados en trading!</p>
        </div>
      </div>
    </section>
