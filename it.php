...
<main class="club it">
      ...
      <div class="container">
        <div class="row valign-row-l">
          ...
          <!-- <div class="col s12 m12 l5"> -->
            <h1>Club IT</h1>
            <p>¿Te interesa la tecnología? ¿Querés saber cuales son las novedades en el sector? En el Club IT vas a
  ...
  <section class="container section center sponsor">
    ...
    <a class="sponsor" href="https://www.globant.com/" target="_blank" rel="noreferrer"><img
        src="img/sponsors/logo-globant.png" class="responsive-img"  alt="globant"></a>
